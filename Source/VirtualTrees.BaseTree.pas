                        ...
                        begin
                          ...
                          begin
                            ...
                            begin
                              if BidiMode = bdLeftToRight then
                              begin
                                DoDrawGridHLine(PaintInfo, CellRect.Left + PaintInfo.Offsets[ofsCheckBox] - fImagesMargin, CellRect.Right - LineWidth, CellRect.Bottom - LineWidth);
                              end
                              else
                              begin
                                DoDrawGridHLine(PaintInfo, CellRect.Left, CellRect.Right - IfThen(toFixedIndent in FOptions.PaintOptions, LineWidth, IndentSize) * FIndent - 1, CellRect.Bottom - LineWidth);
                              end;
                            end
                            else
                              DoDrawGridHLine(PaintInfo, CellRect.Left, CellRect.Right, CellRect.Bottom - LineWidth);
                            ...
                            begin
                              ...
                              begin
                                ...
                                begin
                                  ...
                                  begin
                                    DoDrawGridVLine(PaintInfo, CellRect.Top, CellRect.Bottom, CellRect.Right - LineWidth, ColumnIsFixed and (NextColumn >= 0));
                                  end;
